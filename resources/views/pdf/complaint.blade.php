        ...
        <div class="caja_grande">
            ...
            <div>
                ...
                <div>
                    ...
                    --><p class="atributo valor_doble">{{ $complaint->complainant->typeDependency->name ?? 'No especificada' }}</p>
                </div>
                ...
                <div>
                    ...
                    --><p class="atributo valor_doble primer_atributo">El denunciante actúa en representación de terceros</p>
                </div>
                @endif
                ...
                <div>
                    ...
                    <p class="atributo nombre primer_atributo">Nombre</p><!--
                    --><p class="atributo valor_doble primer_atributo">{{ $complaint->denounced->name ?? 'Sin información' }}</p>
                ...
                @endif
                    ...
                    <p class="atributo nombre_largo primer_atributo">Nivel jerárquico del denunciado con respecto a la víctima</p><!--      
                    --><p class="atributo valor_corto primer_atributo">{{ $complaint->hierarchicalLevel->name ?? 'No especificado' }}</p>
