...
class InmuebleController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $cacheKey = "inmuebles_page_{$page}_per_{$perPage}_sort_{$sortBy}_{$sortOrder}";
    ...
    public function store(InmuebleRequest $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'Location' => route('api.inmuebles.show', $inmueble->id)
        ]);
    }
    ...
    public function filter(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => new InmuebleCollection($inmuebles),
            'meta' => [
                'filters_applied' => $request->only(['numero', 'descripcion', 'calle', 'created_at_from', 'created_at_to']),
                'total_results' => $inmuebles->total()
            ]
        ], Response::HTTP_OK);
    }
    ...
    public function export(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'download_url' => route('api.inmuebles.export.download', ['format' => $format])
            ]
        ], Response::HTTP_OK);
    }
