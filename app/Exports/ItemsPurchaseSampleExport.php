    ...
    public function generateSampleData()
    {
        $sampleData = [
            ...
            [
                ...
                'Dist. Regional' => '15-1',
                'Asignación Presupuestaria' => 'Presupuesto 1',
            ...
            [
                ...
                'Meses envio OC' => 'Jun',
                'Dist. Regional' => '15-1',
                'Asignación Presupuestaria' => 'Presupuesto 2',
            ...
            [
                ...
                'Dist. Regional' => '15-1',
                'Asignación Presupuestaria' => 'Presupuesto 3',
            ...
            [
                ...
                'Dist. Regional' => '15-1',
                'Asignación Presupuestaria' => 'Presupuesto 4',
            ...
            [
                ...
                'Meses envio OC' => 'Dic',
                'Dist. Regional' => '15-1',
                'Asignación Presupuestaria' => 'Presupuesto 5',
        ...
        if ($this->rows > 10) {
            ...
            for ($i = 11; $i <= $this->rows; $i++) {
                ...
                $additionalRows[] = [
                    ...
                    'Total/Item' => ($baseRow['Cantidad'] + rand(1, 5)) * ($baseRow['Monto'] + rand(10000, 50000)),
                    'Cantidad OC' => $baseRow['Cantidad OC'],
                    'Meses envio OC' => $baseRow['Meses envio OC'],
                    'Dist. Regional' => $baseRow['Dist. Regional'],
                    'Asignación Presupuestaria' => $baseRow['Asignación Presupuestaria'] . ' - Variante ' . ($i - 10),
